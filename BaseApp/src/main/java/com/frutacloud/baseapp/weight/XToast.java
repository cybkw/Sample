...
public class XToast {
    ...
    private static Context context = Tools.getContext();
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = Tools.getDrawable(context, R.drawable.xtoast_warning);
        }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = Tools.getDrawable(context, R.drawable.xtoast_info);
        }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = Tools.getDrawable(context, R.drawable.xtoast_success);
        }
    ...
    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        Drawable icon = null;
        if (withIcon) {
            icon = Tools.getDrawable(context, R.drawable.xtoast_error);
        }
    ...
    public static Toast custom(@NonNull String message, @DrawableRes int iconRes,
        ...
        return custom(message, Tools.getDrawable(context, iconRes), textColor, tintColor, duration);
    }
